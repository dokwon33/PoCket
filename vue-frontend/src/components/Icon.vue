...
const ICONS = {
  ...
  // ── AI 매칭 ──
  alert: [
    'M12 3.6L21.2 19.6H2.8z',
    'M12 9.6v4.2',
    'M12 16.6v.1'
  ],
  // 별 세 개 — 생성/추론을 뜻하는 관용 기호
  sparkle: [
    'M12 3.2l1.9 4.9 4.9 1.9-4.9 1.9L12 16.8l-1.9-4.9L5.2 10l4.9-1.9z',
    'M18.6 15.4l.8 2 2 .8-2 .8-.8 2-.8-2-2-.8 2-.8z',
    'M5.6 3.6l.6 1.5 1.5.6-1.5.6-.6 1.5-.6-1.5L3.5 5.7l1.5-.6z'
  ]
}
